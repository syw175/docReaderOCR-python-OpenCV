...
def main():
    ...
    # Perform contour detection to get the contours of these edges and sort them by area, plot onto blank canvas
    ...
    # Use the Douglas-Peucker algorithm to approximate the corners of the document
